...
const ContactCreate = () => {
  ...
  const submitHandler = (e) => {
    e.preventDefault()
    try {
      api.post(`/app/vendorpartners/createvendorpartner`, contactInfo)
        .then(res => {
            ...
            <div className="card-body pt-0">
              <form onSubmit={submitHandler}>
                <div className="row">
                  ...
                  <div className="col-md-6 mt-3">
                    <label htmlFor="type">Contact Type <span className='required'>*</span></label>
                    <select name="type" id="type" className='form-select' value={contactInfo.type} onChange={changeHandler} required >
